...
if [ "$speed" = "1428000" ]; then
    echo 07 > /sys/kernel/debug/dri/129/pstate
...
if [ "$speed" = "1122000" ]; then
    echo 05 > /sys/kernel/debug/dri/129/pstate
...
if [ "$speed" = "714000" ]; then
    echo 03 > /sys/kernel/debug/dri/129/pstate
...
if [ "$speed" = "510000" ]; then
    echo 02 > /sys/kernel/debug/dri/129/pstate
    echo 02 > /sys/kernel/debug/dri/128/pstate
fi
