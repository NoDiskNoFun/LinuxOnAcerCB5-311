...
start_progress "Installing KDE"

# add .xinitrc to /etc/skel that defaults to plasma session
...
echo "KDE, Chromium Webbrowser, and a set of standard Tools"
echo ""
